...
const createNewApplication = async(req, res) => {
    try{
        ...
        let list = [data.child.name, data.child.date, data.child.age, data.child.gender, data.child.state, data.child.email, data.child.contact_no, data.child.degree, data.child.type, JSON.stringify(data.father),JSON.stringify(data.mother)]
...
module.exports = {createNewApplication, checkApplicationStatus, getApplicationDetails,updatestatus, filterApplicationsForHOD, getApplicationDetailsForZC}